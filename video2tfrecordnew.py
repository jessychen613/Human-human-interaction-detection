...
max_video_record = 10
FLAGS = flags.FLAGS
flags.DEFINE_integer('n_videos_in_record', 201,
...
flags.DEFINE_string('file_suffix', "*.avi",
                    'defines the video file type, e.g. .avi')
...
def convert_videos(source_path, destination_path, n_videos_in_record=201, n_frames_per_video='all',
                               file_suffix="*.avi", dense_optical_flow=False,
...
#  print(filenames)
#  print("filenames_split", filenames_split)
...
#  print("current_batch_number,total_batch_number",current_batch_number,total_batch_number)
#  print(data.shape, num_videos, num_images, height, width, num_channels)
...
#       print('before feature video')
       feature['video'] = _bytes_feature(image_raw)
#      feature['height'] = _int64_feature(height)
#      feature['width'] = _int64_feature(width)
#      
       feature['height'] = _int64_feature(height)
       feature['width'] = _int64_feature(width)
       feature['channel'] = _int64_feature(num_channels)
       feature['num_images'] = _int64_feature(num_images)
#      print('label', label)
 ...
 #   print("After tf.train.Example")
       writer.write(example.SerializeToString())

    print("Write complete")
  if (writer is not None) & (current_batch_number==total_batch_number):
    print("Write close")
    writer.close()
...
#  print("video_file_to_ndarray before while")
...
#      print("frames_counter", frames_counter)
 ...
 #       print("video_file_to_ndarray after cv2.cvtColor 1")
...
def convert_video_to_numpy(filenames, n_frames_per_video, width, height,
  ...
  for i, file in enumerate(filenames):
    try:
      print("before video_file_to_ndarray")
